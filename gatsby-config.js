module.exports = {
  siteMetadata: {
    ...
    other: [
      {
        name: '학부연구생, Yeungnam Univ. (2021.03-2024.02)',
        description: '',
        link: '',
      },
      {
        name: '국가우수장학생 성장지원 멘토링 멘토 (2025. 12. 4.)',
        description: '',
        link: '',
      },
    ],
